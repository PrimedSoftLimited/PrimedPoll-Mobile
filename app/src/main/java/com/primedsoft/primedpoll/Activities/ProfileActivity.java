...
//        googleSignOut(signOut);
    ...
    private void googleSignOut(Button signOut) {
    ...
    private void setGoogleDataOnView() {
...
if(googleSignInAccount != null){
    ...
    private void setFacebookDataOnView() {

    }

    public void setNotLoggedIn() {
        String notLogged = getIntent().getStringExtra(getString(R.string.not_logged));
        if (notLogged != null) {
            profileName.setText(notLogged);
        }
    }
}
