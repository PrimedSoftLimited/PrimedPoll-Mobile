...
public class Profile_User extends AppCompatActivity {
    ...
    private InterestAdpter myAdapter;
...
//                do something
            ...
            case R.id.username_user:
                ...
                final EditText input_name = new EditText(Profile_User.this);
...
//        alertDialog.setIcon(R.drawable.);
            ...
            case R.id.email:
//                do something
                AlertDialog.Builder alertDialog_email = new AlertDialog.Builder(Profile_User.this);
                alertDialog_email.setTitle("EMAIL");
                alertDialog_email.setMessage("Enter Email");

                final EditText input_email = new EditText(Profile_User.this);
...
//        alertDialog.setIcon(R.drawable.);
            ...
            case R.id.phone_no:
//                do something
                AlertDialog.Builder alertDialog_phone = new AlertDialog.Builder(Profile_User.this);
                alertDialog_phone.setTitle("EMAIL");
                alertDialog_phone.setMessage("Enter Email");

                final EditText input_phone = new EditText(Profile_User.this);
...
//        alertDialog.setIcon(R.drawable.);
            ...
            case R.id.D_O_B:
//                do something
                AlertDialog.Builder alertDialog_dob = new AlertDialog.Builder(Profile_User.this);
                alertDialog_dob.setTitle("DATE OF BIRTH");
                alertDialog_dob.setMessage("Enter Date of Birth");

                final EditText input_dob = new EditText(Profile_User.this);
